...
public class Magpie2
{
    ...
    {
        String response = "";
        // check that the statement has at least one character, the other part of the code in under the else.
        ...
        else if (findKeyword(statement,"lollipop",0) >= 0) {
            response =  "I love lollipops";
        }
        else if (findKeyword(statement,"candy",0) >= 0) {
            response =  "CANDY? I want some of that!";
        }
        ...
        //keyword "dad" edited
            ...
            response =  "My father used to give me candy after school";
        }

        // keyword "sister" edited
        else if (findKeyword(statement,"sister",0) >= 0) {
            response = "My sister used to take care of me when I was little";
        }
        // keyword "brother" edited
        ...
        else if (findKeyword(statement,"Ms.",0) >= 0 || findKeyword(statement,"Rakestraw",0) >= 0) {
            response = "She sounds like a good teacher.";
        }

        else
        {
            //theother part of the trim, its under the else statement so the it does not print "say something else" twice
            if(str.length() <= 0) {
